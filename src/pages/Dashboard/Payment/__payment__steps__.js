 ...
 * 5. create payment intent post on the server and retrun client secret.
 * install stripe on the server side and get client secret. make sure you use thr payment method types: ['card']
 * 6. from cient side get the client secret and save it.
